 ...
 * the faucet output. Things usually fit, but rules containing VM UUIDs
 * end up being particularly long. We subtract 60 characters to allow for
 * prefixes to the generated description text.
 *
...
var COLUMNS = USING_FAUCET ?
    (process.stderr.columns || 80) - 60 : Infinity;
